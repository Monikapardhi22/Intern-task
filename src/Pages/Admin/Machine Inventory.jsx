          ...
          <div className='sm:mt-[100px] '>
            ...
            <div className='p-3 bg-black shadow sm:px-16'>
              ...
              <div className='flex  justify-center items-center flex-col sm:flex lg:flex lg:flex-row  sm:justify-center sm:items-center'>
                ...
                <div className='border-[1px] border-blue-500 w-1/4 sm:p-7 m-3 h-[100px] bg-violet-50 text-xl sm:w-1/7  text-blue-400 font-semibold rounded-xl  flex flex-col justify-center items-center'>
                  Sold <div className='flex justify-center items-center mt-3.5 text-2xl'>
                    0   <img src={singlelayer} className='h-[30px] ml-2' />
                  </div>
                </div>
                 <div className='border-[1px] border-blue-500 m-3 sm:p-7 w-1/4 h-[100px] bg-violet-50 text-xl sm:w-1/7  text-blue-400 font-semibold rounded-xl  flex flex-col justify-center items-center'>
                  Applied <div className='flex justify-center items-center mt-3.5 text-2xl'>
                    1  <img src={layer} className='h-[30px] ml-2' />
                  </div>
                </div>
                <div className='border-[1px] border-blue-500 w-1/4 m-3 sm:p-7 h-[100px] bg-violet-50 text-xl sm:w-1/7  text-blue-400 font-semibold rounded-xl  flex flex-col justify-center items-center'>
                  Franchise <div className='flex justify-center items-center mt-3.5 text-2xl'>
                    0   <img src={singlelayer} className='h-[30px] ml-2' />
                  </div>
                </div>
                <div className='border-[1px] border-blue-500 m-3 w-1/4 sm:p-7 h-[100px] bg-violet-50 text-xl sm:w-1/7  text-blue-400 font-semibold rounded-xl  flex flex-col justify-center items-center'>
