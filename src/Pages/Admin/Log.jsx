...
export default function Log() {
    ...
    return (
        <div>
            ...
            <nav className="px-2 w-full  sm:h-full h-screen bg-black   flex justify-between sm:items-center ">
                <div className="lg:flex lg: lg: lg:flex-row sm:flex sm:flex-col ">
                    <div className="bg-black rounded-lg shadow-white lg: lg:overflow-x-hidden lg:overflow-y-auto sm:p-7 p-1 m-2  text-white">
                        ...
                        <button
                            className="block text-2xl text-white lg:hidden lg:w-0 lg:h-0 m-4  mt-24 mb-4 sm:mb-0"
                    ...
                    <div className='ml-14 mr-14 mb-14  sm:w-[750px]'>
                        <div className='  sm:block text-4xl  text-white mt-20 font-semibold mb-5  sm:mt-8 sm:m-7'>
                            Logs
                        </div>
                        <div className='bg-transparent shadow-lg p-2 sm:p-7 rounded-md  '>
                            <div className='flex justify-center items-center'>
                                <div className='sm:m-3 flex flex-col'>
                                <input type='text' placeholder='Machine Code' className='border-b-[1px] border-gray-400  shadow-lg bg-black text-white w-[110px] ml-2.5 sm:w-[200px] sm:text-[18px] placeholder:text-gray-300   sm:p-4 p-1 rounded-md  focus:border-blue-400 focus:outline-none ' />
                                <button className='text-lg border-b-[1px]  border-gray-300 rounded-md text-blue-400 sm:p-4 sm:mt-3 ml-4 mr-9 sm:w-1/2   focus:bg-blue-300 focus:text-black focus:border-blue-300 focus:transition-colors focus:duration-300 focus:ease-in-out cursor-pointer mt-1'>Show</button>
                            </div>
                            <div>
                                {/* <img src={vending} className='sm:h-full sm:w-full h-[200px] w-[100px]' /> */}
                            </div>
                            </div>
                            <div className='sm:m-3 mt-6 flex m-3 sm:flex-row text-white  flex-col sm:justify-center sm:items-center justify-center items-center'>
                               Date:  <input type='date' placeholder='Date' className='border-b-2 border-gray-300 font-light text-white rounded-md p-1 m-1 placeholder:text-white' />
                                Time:<input
                                    type="time"
